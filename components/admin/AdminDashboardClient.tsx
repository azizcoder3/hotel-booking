...
import { List, Calendar as CalendarIcon, Check, X, DollarSign, User, Calendar, Mail } from 'lucide-react'
import AdminCalendar from './AdminCalendar'
import AdminMessages from './AdminMessages' // <--- IMPORT
...
// On ajoute le type pour les messages
interface Message {
  id: string
  name: string
  email: string
...
// On ajoute la prop messages ici
  ...
  return (
    <div>
      ...
      {view === 'calendar' ? (
        ...
        <AdminMessages messages={messages} /> // <--- AFFICHAGE MESSAGES
      ) : (
        // VUE LISTE (Ton tableau existant)
